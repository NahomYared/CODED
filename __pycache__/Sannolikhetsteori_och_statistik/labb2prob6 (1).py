...
# Anpassa legendens position och storlek
plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), fontsize='small', ncol=2)
plt.title("Födelsevikter och konfidensintervall")
plt.tight_layout()  # Justera layouten för att undvika överlapp
plt.show()
