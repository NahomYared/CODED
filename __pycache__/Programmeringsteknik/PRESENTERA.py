...
class AtomGUI(tk.Tk):
    ...
    def __init__(self):
        """
        Skapar en ny instans av AtomGUI.
    ...
    def visa_alla_atomerna(self):
        ...
        for atom in atom_lista_objekt.atomlista: #För varje atom i listan
    ...
    def träna_periodiska_systemet(self):
        ...
        self.bygg_periodiskt_system(atom_lista_objekt) #Placera i periodiska systemet-spelet anropas
    ...
    def bygg_periodiskt_system(self, atomlista):
        atom_lista_objekt.listan_av_atomerna() #När funktionen listan_av_atomerna anropas så fylls atomlista med atomer, 
    ...
    Argument:
        ...
        atomlista: En lista av Atom-objekt som representerar de tillgängliga atomerna.
...
class Atomlista:
    ...
    """Denna ska se till att vi byter plats på atomerna, 
    förklaringen ges i de gröna kommentarerna
